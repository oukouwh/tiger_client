...
describe('Quotation Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'quotation', component: QuotationComponent }]), HttpClientTestingModule],
  ...
  describe('trackId', () => {
    it('Should forward to quotationService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getQuotationIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getQuotationIdentifier).toHaveBeenCalledWith(entity);
